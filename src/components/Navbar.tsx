              ...
              {user ? (
                ...
                <>
                  ...
                  <div className="relative group">
                    <Link
                      to="/report"
                      className="hover:bg-blue-700 p-2 rounded-md transition-colors flex items-center justify-center"
                      title="Report Issue"
                    >
                      <svg
                  ...
                  <div className="relative group">
                    <button
                      ...
                      className="hover:bg-blue-700 p-2 rounded-md transition-colors flex items-center justify-center relative"
                      title="Notifications"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="text-right">
                        ...
                        <span className="text-xs text-blue-300 block">
                          {userProfile?.region} • {userProfile?.role === 'super-admin' ? 'Super Admin' : userProfile?.role === 'admin' ? 'Admin' : 'User'}
                        </span>
                      </div>
                    </div>
                  </div>
